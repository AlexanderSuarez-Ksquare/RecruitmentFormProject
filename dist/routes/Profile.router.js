...
exports.ProfileRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const profile = yield (0, Profile_repo_1.getProfileById)(id);
        if (profile) {
...
exports.ProfileRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedProfile = yield (0, Profile_repo_1.updateProfileById)(id, data);
        if (updatedProfile) {
...
exports.ProfileRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const success = yield (0, Profile_repo_1.deleteProfileById)(id);
        if (success) {
