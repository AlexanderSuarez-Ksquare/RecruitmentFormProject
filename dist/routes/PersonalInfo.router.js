...
exports.PersonalInfoRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const personalInfo = yield (0, PersonalInfo_repo_1.getPersonalInfoById)(id);
        if (personalInfo) {
...
exports.PersonalInfoRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedPersonalInfo = yield (0, PersonalInfo_repo_1.updatePersonalInfoById)(id, data);
...
exports.PersonalInfoRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const success = yield (0, PersonalInfo_repo_1.deletePersonalInfoById)(id);
        if (success) {
