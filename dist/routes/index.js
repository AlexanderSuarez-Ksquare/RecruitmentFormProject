...
const Skill_router_1 = require("./Skill.router");
...
APIRouter.use("/governmentInfo", GovermentInfo_router_1.GovernmentInfoRouter);
...
APIRouter.use("/skill", Skill_router_1.SkillRouter);
