...
exports.AddressRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const address = yield (0, Address_repo_1.getAddressById)(id);
        if (address) {
...
exports.AddressRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedAddress = yield (0, Address_repo_1.updateAddressById)(id, data);
        if (updatedAddress) {
...
exports.AddressRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const success = yield (0, Address_repo_1.deleteAddressById)(id);
        if (success) {
